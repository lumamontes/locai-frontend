...
export default function Navbar() {
	...
	const deleteMutation = useMutation(
		(id) => api.delete(`user_favorites/${id}`),
		{
		  onSuccess: () => {
	...
	const { data: favorites, isLoading, error } = useQuery('user_favorite_id', async () => {
		const response = await api.get(`/user_favorites/${user.id}`)
				...
				<div id="ltn__utilize-cart-menu" className="ltn__utilize ltn__utilize-cart-menu">
					<div className="ltn__utilize-menu-inner ltn__scrollbar">
						...
						<div className="mini-cart-product-area ltn__scrollbar">
							Faça login para adicionar imóveis favoritos
						</div>
							...
							return (
								<div className="mini-cart-item clearfix">
									<div className="mini-cart-img go-top">
										...
										<span className="mini-cart-item-delete" onClick={() => deleteMutation.mutate(item.id)}><i className="icon-cancel" /></span>
									</div>
